...
export class FoodComponent {
  foodImages: string[] = [
    'assets/i1.jpg', 'assets/i2.jpg', 'assets/i3.webp', 'assets/i4.webp',
    'assets/i5.webp', 'assets/i6.webp', 'assets/i7.webp', 'assets/i9.webp',
    'assets/i10.webp', 'assets/i11.webp', 'assets/i12.webp', 'assets/i13.webp',
    'assets/i14.webp'
  ];
  ...
  jsonServerBaseUrl = 'http://localhost:3001/food'; // ✅ JSON Server URL for Food category
  commentsUrl = 'http://localhost:3001/food-comments'; // ✅ JSON Server URL for storing comments
  ratingsUrl = 'http://localhost:3001/food-ratings'; // ✅ JSON Server URL for storing ratings
  ...
  getAllImages(): string[] {
    return [...this.uploadedImages, ...this.foodImages];
  }
}
