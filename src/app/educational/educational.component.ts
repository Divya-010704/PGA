...
export class EducationalComponent {
  educationalImages: string[] = [
    'assets/alphabet.webp', 'assets/computer.webp', 'assets/maths.webp', 'assets/humanbody.webp',
    'assets/fodchain.webp', 'assets/educationalcartoon.webp', 'assets/periodictable.webp', 'assets/solar1.webp',
    'assets/plantgrowthstage.webp', 'assets/transportation.webp', 'assets/solarsystem.webp', 'assets/worldmap.webp',
    'assets/water.webp'
  ];
  ...
  jsonServerBaseUrl = 'http://localhost:3001/educational'; // ✅ JSON Server URL for Educational category
  commentsUrl = 'http://localhost:3001/educational-comments'; // ✅ JSON Server URL for storing comments
  ratingsUrl = 'http://localhost:3001/educational-ratings'; // ✅ JSON Server URL for storing ratings
  ...
  getAllImages(): string[] {
    return [...this.uploadedImages, ...this.educationalImages];
  }
}
